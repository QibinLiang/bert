...
import datasets.download.download_manager as download_manager
...
class WikitextConfig(datasets.BuilderConfig):
    ...
    def __init__(self, data_url, cache_dir=None, **kwargs):
        ...
        with open(data_file, encoding="utf-8") as f:
            for idx, row in enumerate(f):
                if row.strip():
                    ...
                    yield idx, {"text": ""}
wiki = Wikitext(config_name='wikitext-2-raw-v1')
wiki_config = wiki.BUILDER_CONFIGS[1]
dlmanager = download_manager.DownloadManager(wiki_config)
data = wiki._split_generators(dlmanager)
print(" ===================================================== ")
print(" ===================== WARNING ======================= ")
print(" ===================================================== ")
print(" ==== Please manually copy and paste the dataset  ==== ")
print(" ==== from the path shown below to where you want ==== ")
print(" ===================================================== ")
print(" ===================================================== ")
for item in data:
    print("data split: {}.\nlocation: {}".format(item.name, item.gen_kwargs['data_file']))